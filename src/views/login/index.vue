...
import { formData, formTemplate } from "./useForm"
...
<template>
	<div class="flex items-center justify-center min-h-screen bg-bg text-text">
		<div class="w-full max-w-md p-8 rounded-2xl shadow-md bg-card-bg border border-border">
			...
			<!-- 登录按钮 -->
			<button
				class="w-full py-2 px-4 rounded-lg bg-primary text-invert font-medium shadow hover:bg-primary/90 transition-colors">Login</button>
			<!-- 额外操作 -->
